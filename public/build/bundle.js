(() => {
  // node_modules/.pnpm/svelte@3.42.6/node_modules/svelte/internal/index.mjs
  function noop() {
  }
  ...
  var file = "src/compary/Compary.svelte";
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        t1 = space();
        input = element("input");
        attr_dev(img0, "class", "compary__left svelte-g9qzhh");
        if (!src_url_equal(img0.src, img0_src_value = ctx[2].after))
          attr_dev(img0, "src", img0_src_value);
        attr_dev(img0, "alt", "after");
        add_location(img0, file, 1, 1, 98);
        attr_dev(img1, "class", "compary__right svelte-g9qzhh");
        if (!src_url_equal(img1.src, img1_src_value = ctx[2].before))
          attr_dev(img1, "src", img1_src_value);
        attr_dev(img1, "alt", "before");
        add_location(img1, file, 2, 1, 157);
        attr_dev(input, "type", "range");
        attr_dev(input, "class", "compary__range svelte-g9qzhh");
        attr_dev(input, "min", "0");
        attr_dev(input, "max", "100");
        input.value = ctx[0];
        add_location(input, file, 3, 1, 219);
        attr_dev(section, "class", "compary svelte-g9qzhh");
        set_style(section, "--compary-value", ctx[0] + "%");
        set_style(section, "--compary-thumb", ctx[1] || "");
      ...
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          dispose = [
            listen_dev(input, "input", ctx[4], false, false, false),
      ...
      p: function update2(ctx2, [dirty]) {
        if (dirty & 4 && !src_url_equal(img0.src, img0_src_value = ctx2[2].after)) {
          attr_dev(img0, "src", img0_src_value);
        }
        if (dirty & 4 && !src_url_equal(img1.src, img1_src_value = ctx2[2].before)) {
          attr_dev(img1, "src", img1_src_value);
        }
        if (dirty & 1) {
        ...
        if (dirty & 1) {
          set_style(section, "--compary-value", ctx2[0] + "%");
        }
        if (dirty & 2) {
          set_style(section, "--compary-thumb", ctx2[1] || "");
        }
      },
      i: noop,
      o: noop,
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    validate_slots("Compary", slots, []);
    const dispatch = createEventDispatcher();
    let { value = 50, thumbcolor = "", img = { after: "", before: "" } } = $$props;
    const writable_props = ["value", "thumbcolor", "img"];
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
        console.warn(`<Compary> was created with unknown prop '${key}'`);
    });
  ...
  var Compary = class extends SvelteComponentDev {
    constructor(options) {
      super(options);
    ...
    get value() {
      throw new Error("<Compary>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    }
    set value(value) {
      throw new Error("<Compary>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    }
    get thumbcolor() {
      throw new Error("<Compary>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    }
  ...
  function create_fragment2(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        t2 = text("!");
        t3 = space();
        create_component(compary.$$.fragment);
        attr_dev(b, "class", "svelte-wa0bx4");
        add_location(b, file2, 10, 10, 177);
        add_location(h1, file2, 10, 0, 167);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
      m: function mount(target, anchor) {
        ...
        mount_component(compary, target, anchor);
        current = true;
      },
      p: noop,
      i: function intro(local) {
        if (current)
          return;
        transition_in(compary.$$.fragment, local);
        current = true;
      },
      o: function outro(local) {
        transition_out(compary.$$.fragment, local);
        current = false;
      },
      d: function destroy(detaching) {
        if (detaching)
        ...
        if (detaching)
          detach_dev(t3);
        destroy_component(compary, detaching);
      }
    };
    dispatch_dev("SvelteRegisterBlock", {
      block,
  ...
  function instance2($$self, $$props, $$invalidate) {
    ...
    $$self.$capture_state = () => ({ Compary: Compary_default, name, value, img });
    $$self.$inject_state = ($$props2) => {
      if ("name" in $$props2)
