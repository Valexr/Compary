  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        t1 = space();
        input = element("input");
        attr_dev(img0, "class", "compary__left svelte-q87536");
        if (!src_url_equal(img0.src, img0_src_value = ctx[2].after))
          attr_dev(img0, "src", img0_src_value);
        attr_dev(img0, "alt", "after");
        add_location(img0, file, 11, 1, 290);
        attr_dev(img1, "class", "compary__right svelte-q87536");
        if (!src_url_equal(img1.src, img1_src_value = ctx[2].before))
          attr_dev(img1, "src", img1_src_value);
        attr_dev(img1, "alt", "before");
        add_location(img1, file, 12, 1, 349);
        attr_dev(input, "type", "range");
        attr_dev(input, "class", "compary__range svelte-q87536");
        attr_dev(input, "min", "0");
        attr_dev(input, "max", "100");
        input.value = ctx[0];
        add_location(input, file, 13, 1, 411);
        attr_dev(section, "class", "compary svelte-q87536");
        set_style(section, "--compary-value", ctx[0] + "%");
        set_style(section, "--compary-thumb", ctx[1] || "");
        add_location(section, file, 10, 0, 192);
      },
