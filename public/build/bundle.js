(() => {
  // node_modules/.pnpm/svelte@3.42.5/node_modules/svelte/internal/index.mjs
  function noop() {
  }
  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        t1 = space();
        input = element("input");
        attr_dev(img0, "class", "c-compare__left svelte-1p7o7my");
        if (!src_url_equal(img0.src, img0_src_value = ctx[2].left))
          attr_dev(img0, "src", img0_src_value);
        attr_dev(img0, "alt", "after");
        add_location(img0, file, 14, 1, 303);
        attr_dev(img1, "class", "c-compare__right svelte-1p7o7my");
        if (!src_url_equal(img1.src, img1_src_value = ctx[2].right))
          attr_dev(img1, "src", img1_src_value);
        attr_dev(img1, "alt", "before");
        add_location(img1, file, 15, 1, 363);
        attr_dev(input, "type", "range");
        attr_dev(input, "class", "c-compare__range svelte-1p7o7my");
        attr_dev(input, "min", "0");
        attr_dev(input, "max", "100");
        input.value = ctx[0];
        add_location(input, file, 16, 1, 426);
        attr_dev(section, "class", "c-compare svelte-1p7o7my");
        set_style(section, "--value", ctx[0] + "%");
        set_style(section, "--thumb-bgc", ctx[1]);
        add_location(section, file, 13, 0, 221);
      },
      ...
      p: function update2(ctx2, [dirty]) {
        if (dirty & 4 && !src_url_equal(img0.src, img0_src_value = ctx2[2].left)) {
          attr_dev(img0, "src", img0_src_value);
        }
        if (dirty & 4 && !src_url_equal(img1.src, img1_src_value = ctx2[2].right)) {
          attr_dev(img1, "src", img1_src_value);
        }
        if (dirty & 1) {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    let { value = 50, thumbcolor = "hsl(339.1, 80.9%, 61%)", img = { left: "", right: "" } } = $$props;
  ...
  function create_fragment2(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(b, file2, 10, 10, 175);
        add_location(h1, file2, 10, 0, 165);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
